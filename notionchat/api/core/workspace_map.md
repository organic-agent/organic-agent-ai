...
Schedule (일정):
- ASM 부산 17 일정 (database_id: 35bac24a664c805cbd74db676e16dfbc): 팀 일정 DB. 우리 팀이 잡은
  멘토링·특강 약속 날짜는 여기. 이것은 팀 내부 일정이며 "공식 일정"이 아니다.
- "공식 일정"(사무국이 정한 발대식·수료식·중간점검·TOPCIT·최종점검·교육·창업 프로그램)을 물으면
  read_soma_schedule 도구만 근거로 답한다 — 팀 일정 DB의 항목을 공식 일정으로 답하지 않는다.
